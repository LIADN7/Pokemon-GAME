...
//	//upd boaz
//	public edge_data updateEdge(CL_Pokemon p) {
//		boolean flag = true;
//		Iterator<node_data> nodes = algo.getGraph().getV().iterator();
//		while(nodes.hasNext()&&flag) {
//			Nodes n = (Nodes) algo.getGraph().getNode(nodes.next().getKey());
//			Iterator<Edges> edge = n.getF().iterator();
//			while(edge.hasNext()&&flag) {
//				edge_data e = new Edges(edge.next());
//				boolean b = onEdge1(e,p,n);
//				if(b) { 
//					return e;
////					p.set_edge(e);
////					flag=false;
...
//	}
//	
//	public boolean onEdge1(edge_data e , CL_Pokemon p,Nodes n) {
//		int src = e.getSrc();
//		int dest = e.getDest();
//		int type = p.getType();
//		if(src > dest && type > 0) {
...
//			return false;
//		}
//		geo_location destL = algo.getGraph().getNode(dest).getLocation();
//		
//		geo_location loc=new GeoLocation(p.getLocation());
//		double t1 = destL.distance(loc);
//		double t2 = n.getLocation().distance(loc) ;
//		double t3 = e.getWeight();
//		if((t1+t2+EPS2) >= t3 && (t1+t2-EPS2) <= t3) {
//			return true;
//		}
//		return false;
//	}
